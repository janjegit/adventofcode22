...
/* package adventofcade-0.1.0.0 */
#ifndef VERSION_adventofcade
#define VERSION_adventofcade "0.1.0.0"
#endif /* VERSION_adventofcade */
#ifndef MIN_VERSION_adventofcade
#define MIN_VERSION_adventofcade(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_adventofcade */
...
#define CURRENT_COMPONENT_ID "adventofcade-0.1.0.0-inplace-deklprog-template"
